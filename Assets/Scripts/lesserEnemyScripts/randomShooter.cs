...
public class randomShooter : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            currentbullet = Instantiate(bullet, new Vector2(transform.position.x - shootDistance, transform.position.y), Quaternion.Euler(0, currentAngle, Random.Range(0,70)));
